...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__cmult

#else
#  define SWIG_init    init_cmult

#endif
#define SWIG_name    "_cmult"
...
extern "C" {
#endif
SWIGINTERN int Swig_var_myfloat_set(PyObject *_val) {
  {
    double val;
    int res = SWIG_AsVal_double(_val, &val);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""myfloat""' of type '""double""'");
    }
    myfloat = static_cast< double >(val);
  }
  return 0;
fail:
  return 1;
...
SWIGINTERN PyObject *Swig_var_myfloat_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_double(static_cast< double >(myfloat));
  return pyobj;
}


SWIGINTERN int Swig_var_myint_set(PyObject *_val) {
  {
    long long val;
    int res = SWIG_AsVal_long_SS_long(_val, &val);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""myint""' of type '""long long""'");
    }
    myint = static_cast< long long >(val);
  }
  return 0;
fail:
  return 1;
...
SWIGINTERN PyObject *Swig_var_myint_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_long_SS_long(static_cast< long long >(myint));
  return pyobj;
}


SWIGINTERN PyObject *_wrap_cmult(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "cmult", 2, 2, swig_obj)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "cmult" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  ecode2 = SWIG_AsVal_float(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "cmult" "', argument " "2"" of type '" "float""'");
  } 
  arg2 = static_cast< float >(val2);
  result = (float)cmult(arg1,arg2);
...
static PyMethodDef SwigMethods[] = {
	 { "cmult", _wrap_cmult, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
# endif
  ...
  SWIG_addvarlink(globals, "myfloat", Swig_var_myfloat_get, Swig_var_myfloat_set);
  SWIG_addvarlink(globals, "myint", Swig_var_myint_get, Swig_var_myint_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
